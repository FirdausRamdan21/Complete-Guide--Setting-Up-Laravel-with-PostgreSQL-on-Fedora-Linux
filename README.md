Berikut adalah panduan lengkap dalam format **README.md** yang sudah dirapikan dan siap kamu gunakan untuk repositori atau dokumentasi proyek:

```markdown
# 🐘 Complete Guide: Setting Up Laravel with PostgreSQL on Fedora Linux

> **A comprehensive step-by-step tutorial for developers setting up a Laravel development environment with PostgreSQL on Fedora Linux**
...
3. [What is Laravel?](#-what-is-laravel)
4. [What is PostgreSQL?](#-what-is-postgresql)
5. [Step-by-Step Installation](#-step-by-step-installation)
   - [Setup PHP](#step-1-setup-php)
   - [Setup Composer](#step-2-setup-composer)
   - [Install PostgreSQL](#step-3-install-postgresql)
   - [Configure PostgreSQL](#step-4-configure-postgresql)
   - [Install PHP PostgreSQL Extensions](#step-5-install-php-postgresql-extensions)
   - [Create Laravel Project](#step-6-create-laravel-project)
   - [Configure Environment](#step-7-configure-environment)
...
This tutorial will guide you through setting up a complete Laravel development environment with PostgreSQL as the database on Fedora Linux. This combination is powerful, modern, and widely used in enterprise applications.

**Why this guide is special:**
- ✅ Specifically tailored for **Fedora Linux** users
- ✅ Uses **PostgreSQL** (enterprise-grade database)
...
|-----------|----------------|-------------|
| **Operating System** | Fedora 38+ | Fedora 40+ |
| **PHP** | 8.1 | 8.4 |
| **PostgreSQL** | 14 | 15+ |
| **Composer** | 2.0 | Latest |
| **Laravel** | 10.x | 11.x |
...
- ✅ **Blade Templating** - Powerful and intuitive views
- ✅ **Artisan CLI** - Command-line tools for development
- ✅ **MVC Architecture** - Clean separation of concerns
- ✅ **Built-in Security** - CSRF, XSS, SQL injection protection
- ✅ **RESTful Routing** - Clean and expressive routes

```php
// Example: Simple Laravel Route
Route::get('/users', function () {
    return User::all(); // Returns all users as JSON
});
